...
Hopefully if you are reading this, you have already completed our [Build a Lapp guide](../build-a-lapp/build-a-lapp-overview.md) and our [Installation guide](../intermediate-get-lit/intermediate-get-lit.md). 
